...
export const getPass = async(payload)=>{
  try{
    const {data}=await axios.post("api/dbLogin",payload);
    return data;
  }
  catch(error){
    console.log(error)
...
export const changeCredentials=async(payload)=>{
  try{
    const {data}=await axios.put("api/dbLogin",payload);
    return data;
  }
  catch(error){
    console.log(error)
...
export const newCredentials=async(payload)=>{
  try{
    const {data}=await axios.post("api/dbLogin",payload);
    return data;
  }
