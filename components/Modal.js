                                ...
                                <div className="relative p-6 flex-auto">
                                    <form  className="bg-white rounded px-8 pt-6 pb-8 mb-4">
                                        ...
                                        <div  className="mb-6">
                                            ...
                                            <textarea  className="appearance-none border border-Orange rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="remarks" placeholder="Remarks" />
