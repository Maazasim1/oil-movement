...
export default function DecantingOut() {
    return (
        <div>
                    ...
                    <form className="w-full max-w-[90%]">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div className="w-full md:w-1/2 px-3">
                                ...
                                <input className="appearance-none block w-full bg-gray-200 text-headBlue border  border-none bg-lastGray  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="time-in" type="temperature" />
                            </div>
                            <div className="w-full md:w-1/2 px-3">
                                <label className="block uppercase tracking-wide text-headBlue text-xs font-bold mb-2" htmlFor="time-in">
                                    Density (KG/LTR)
                                ...
                                <input className="appearance-none block w-full bg-gray-200 text-headBlue border disabled border-none bg-lastGray  rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="time-in" type="temperature" />
                            </div>
                        </div>
